 ...
 * @author huyng
 */
public class TextField_Pas extends JPasswordField {
    ...
    public TextField_Pas() {
        ...
        eye = new ImageIcon(getClass().getResource("/Assets/img/icon_eyeClo.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/Assets/img/icon_eyeClo.png")).getImage();
