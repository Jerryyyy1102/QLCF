...
public class MaterialTabbed extends JTabbedPane {
    ...
    public class MaterialTabbedUI extends MetalTabbedPaneUI {
        ...
        protected void paintTabBorder(Graphics grphcs, int tabPlacement, int tabIndex, int x, int y, int w, int h, boolean isSelected) {
            ...
            if (currentRectangle != null) {
                if (tabPlacement == TOP) {
                    g2.fillRect(currentRectangle.x, currentRectangle.y + currentRectangle.height - 10, currentRectangle.width, 3);
        ...
        protected void paintTabBackground(Graphics g, int tabPlacement, int tabIndex, int x, int y, int w, int h, boolean isSelected) {
            ...
            if (isSelected) {
                g2d.setColor(new Color(138, 91, 43)); // Set selected tab color here
            } else {
                g2d.setColor(new Color(222, 184, 135)); // Set unselected tab color here
            }
            g2d.fill(new Rectangle(x, y, w, h)); // Fill the rectangle with the color
        }
