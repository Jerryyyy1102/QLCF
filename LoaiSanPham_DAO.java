...
public class LoaiSanPham_DAO {
    ...
    static Field[] fields = LoaiSanPham.class.getDeclaredFields();
    private static final String[] tenThuocTinh = new String[]{"MaLoai", "TenLoai"};
    private static final String tenBang = "LoaiSanPham";
    ...
    public static ArrayList<LoaiSanPham> layDanhSach() {
        try {
    ...
    public static boolean sua(LoaiSanPham loaiSanPham, String maLoai) {
        Object[] giaTri = new Object[fields.length];
        for (int i = 0; i < fields.length; i++) {
            try {
                fields[i].setAccessible(true);
